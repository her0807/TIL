...
1. Final 을 사용가능
2. 최초에 생성자를 주입해 null 일 경우가 없다. 
3. 의존관계는 프로그램이 종료되기 전 까지 변할 일이 거의 없다. 
4. 프레임워크에 의존하지 않고 순수한 자바 언어의 특징을 살릴 수 있다. 
...
##  빈 생명주기 콜백
  ...
  ![image](https://user-images.githubusercontent.com/26570275/125156945-17ca8800-e1a3-11eb-8eb6-9f99d1663be1.png)



## @PostConstruct, @PreDestory 로 빈 생명주기를 시작하고 끝낼 수 있다. !
...
싱글톤 : 기본 스코프, 스프링 컨테이너의 시작과 끝까지 유지됨. 

프로토 타입 : 빈의 생성과 의존 관계 주입까지만 관여하고 더는 관리하지 않는 매우 짧은 범위임. -> 종료 메세지가 따로 실행되지는 않음. 

매번 새로 만들어서 의존관계 주입 후, 버려버림



### 웹 관련 스코프

request : 웹 요청이 들어오고 나갈 때 까지만 유지됨. 
...
![image](https://user-images.githubusercontent.com/26570275/125158377-beb32200-e1ab-11eb-9c8c-78428564fa6b.png)